...
public final class HeapDump implements Serializable {
  ...
  public final List<Class<? extends ReachabilityInspector>> stethoscopeClasses;
  ...
  HeapDump(Builder builder) {
    ...
    this.stethoscopeClasses = builder.stethoscopeClasses;
  }
  ...
  public static final class Builder {
    ...
    List<Class<? extends ReachabilityInspector>> stethoscopeClasses;
    ...
    Builder(HeapDump heapDump) {
      ...
      this.stethoscopeClasses = heapDump.stethoscopeClasses;
    }
    ...
    public Builder stethoscopeClasses(List<Class<? extends ReachabilityInspector>> stethoscopeClasses) {
      checkNotNull(stethoscopeClasses, "stethoscopeClasses");
      this.stethoscopeClasses = unmodifiableList(new ArrayList<>(stethoscopeClasses));
      return this;
    }
